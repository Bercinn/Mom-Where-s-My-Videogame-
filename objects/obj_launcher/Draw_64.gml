...
outline_draw_text_transformed(300, string_height("I")/2, _txt[0], .5,.5,0, ol_config(3,, 1, 1,,,1));
outline_draw_text_transformed(300, (string_height("I")/2)*2 + 5, _txt[1], .5,.5,0, ol_config(3,c_black,,1,,,1));
